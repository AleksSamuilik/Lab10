...
public class DeleterAppTest {
    ...
    public void deleteCommentTest1() throws IOException {
        File inputFile = new File("aFolderInClassPath\\InputJavaTest.txt");
        File actualFile = new File("aFolderInClassPath\\Test.txt");
        File expectedFile = new File("aFolderInClassPath\\OutputJavaTest.txt");
